...
{
    private readonly string _connectionString = "Endpoint=sb://mango-svb.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=Bq27Cfb9+u5sgBlA7CXnvxxKRMTze2rwi+ASbEcbWL8=";
